...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hold the first operand for any expression, we sit it to null for now.
    First_Operand: null,
...
//This modifies values each time a button id clicked on.
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_Value does not contain a deccimal point
...
//This function updates the calculator screen with the sontents of Display_Value
